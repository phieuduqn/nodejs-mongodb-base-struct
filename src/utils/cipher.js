...
const encryptAdvantageAES = (
  ...
  const secondCrypted = encryptAES(
    firstCrypted,
    algorithm,
    secondPassword,
    inputEncoding,
...
const decryptAdvantageAES = (
  ...
  const secondDecrypted = decryptAES(
    text,
    algorithm,
    secondPassword,
    inputEncoding,
  ...
  const firstDecrypted = decryptAES(
    secondDecrypted,
    algorithm,
    password,
    inputEncoding,
