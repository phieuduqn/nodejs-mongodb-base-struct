    ...
    errors.map((err) => {
      switch (err.type) {
        ...
        case "date.min":
          err.message = i18n.__(
            "paramsError.numberMin",
            i18n.__(`common.${err.context.key}`),
            moment(err.context.limit).format("DD-MM-YYYY").toString()
          );
          break;
        case "date.max":
          err.message = i18n.__(
